...
const cloud = require('../middlewares/upload');
...
NGORouter.post('/NGO/registration', upload.single('logo'), cloud.uploadSingle, NGOController.createDetails);
...
NGORouter.post('/NGO/bank', auth, upload.single('qr'), cloud.uploadSingle, NGOController.updateBank);
NGORouter.post('/NGO/activity', auth, upload.array('img', 4), cloud.uploadMultiple, NGOController.updateActivity);
